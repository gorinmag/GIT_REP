...
def welcome(message):
    ...
    bot.send_message(message.chat.id,
                     "Добро пожаловать, {0.first_name}!\nЯ - <b>{1.first_name}</b>, бот созданный в помощь геологам. Тут ты найдешь короткую информацию по месторождению Наталкинское. В данный момент я нахожусь в процессе разработки, надеюсь что в скором будующем я буду умнее".format(
...
def lalala(message):
    if message.chat.type == 'private':
        if message.text == "Описание месторождения Наталка":
            ...
            bot.send_message(message.chat.id, 'MineVision это база данных завернутая в интеративную оболочку. Ниже можете выбрать инетересующее действие', reply_markup=markup)
            ...
            bot.send_message(message.chat.id, 'Micromine - это ПО предназначеное для геологов, горных-инженеров и маркшейдеров. Данное ПО имеет огромные возможности для режения задач связанных с горной промышенность, однако нельзя забывать что это всего лишь инструмент', reply_markup=markup)
            ...
            item4_5 = types.InlineKeyboardButton("Просмотр характеристик руды в самосвала", callback_data='4-5')
            item4_6 = types.InlineKeyboardButton("Активация загрузочных блоков в Wenco", callback_data='4-6')

            markup.add(item4_1, item4_2, item4_3, item4_4, item4_5, item4_6)

            bot.send_message(message.chat.id, 'Wenco - это система диспечеризации и база данных, она позволяет вести максимальный контроль за рабочей техникой в карьере', reply_markup=markup)
            ...
            item5_2 = types.InlineKeyboardButton("Определение создержания в подаче на ЗИФ", callback_data='5-2')
            ...
            bot.send_message(message.chat.id, 'В этом разделе находятся подсказки для выполнения следующих работ', reply_markup=markup)
            ...
            bot.send_message(message.chat.id, 'Тут находятся самые необходимые сведения о правилах ТБ и СБ', reply_markup=markup)
    ...
    try:
        if call.message:
            if call.data == '1-1':
                ...
                bot.send_message(call.message.chat.id, MM.it3_11)
            elif call.data == '3-12':
                bot.send_message(call.message.chat.id, MM.it3_12)
            elif call.data == '3-13':
                bot.send_message(call.message.chat.id, MM.it3_13)
            elif call.data == '3-14':
                bot.send_message(call.message.chat.id, MM.it3_14)
            elif call.data == '3-15':
                bot.send_message(call.message.chat.id, MM.it3_15)
            elif call.data == '3-21':
                bot.send_message(call.message.chat.id, MM.it3_21)
            elif call.data == '3-22':
                bot.send_message(call.message.chat.id, MM.it3_22)
            elif call.data == '3-23':
                bot.send_message(call.message.chat.id, MM.it3_23)
            elif call.data == '3-24':
                bot.send_message(call.message.chat.id, MM.it3_24)
            elif call.data == '3-25':
                bot.send_message(call.message.chat.id, MM.it3_25)
            elif call.data == '3-31':
                bot.send_message(call.message.chat.id, MM.it3_31)
            elif call.data == '3-32':
                bot.send_message(call.message.chat.id, MM.it3_32)
            elif call.data == '3-33':
                bot.send_message(call.message.chat.id, MM.it3_33)
            elif call.data == '3-34':
                bot.send_message(call.message.chat.id, MM.it3_34)
            elif call.data == '3-41':
                bot.send_message(call.message.chat.id, MM.it3_41)
            elif call.data == '3-42':
                bot.send_message(call.message.chat.id, MM.it3_42)
            elif call.data == '3-43':
                bot.send_message(call.message.chat.id, MM.it3_43)
            elif call.data == '3-51':
                bot.send_message(call.message.chat.id, MM.it3_51)
            elif call.data == '3-52':
                bot.send_message(call.message.chat.id, MM.it3_52)
            elif call.data == '3-53':
                bot.send_message(call.message.chat.id, MM.it3_53)
            elif call.data == '3-54':
                bot.send_message(call.message.chat.id, MM.it3_54)
            elif call.data == '3-55':
                bot.send_message(call.message.chat.id, MM.it3_55)
            elif call.data == '3-56':
                bot.send_message(call.message.chat.id, MM.it3_56)
            elif call.data == '4-1':
                bot.send_message(call.message.chat.id, wenco.it4_1)
            elif call.data == '4-2':
                bot.send_message(call.message.chat.id, wenco.it4_2)
            elif call.data == '4-3':
                bot.send_message(call.message.chat.id, wenco.it4_3)
            elif call.data == '4-4':
                bot.send_message(call.message.chat.id, wenco.it4_4)
            elif call.data == '4-5':
                bot.send_message(call.message.chat.id, wenco.it4_5)
            elif call.data == '4-6':
                bot.send_message(call.message.chat.id, wenco.it4_6)
            elif call.data == '5-1':
                ...
                item3_12 = types.InlineKeyboardButton("Визуалищация скважин", callback_data='3-12')
                item3_13 = types.InlineKeyboardButton("Создание компрозитов по скважинам", callback_data='3-13')
                ...
                item3_24 = types.InlineKeyboardButton("Присвоение данных в каркасную модель", callback_data='3-24')
                ...
                markup = types.InlineKeyboardMarkup(row_width=1)
                item3_31 = types.InlineKeyboardButton("Создание пустой БМ", callback_data='3_31')
           ...
           # bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text="Подумаю",
                                 # reply_markup=None)
